...
LYRICS = [
    (0.0,  "J'crois qu'j'ai une maladie"),
    (3.0,  "J'les trouve toutes belles, j'les trouve toutes sexy"),
    (7.0,  "Oh, ma baby, mets ta plus belle robe, ce soir c'est samedi"),
    (11.5, "C'est ça la vie, on va faire du shopping si t'es gentille"),
    (15.5, "Elle a les cheveux blonds"),
    (18.0, "Mon bébé c'est la plus belle"),
    (20.5, "C'est mon bijou, c'est mon bonbon, mon bonbon"),
    (24.5, "T'étais là quand je prenais le bus"),
    (28.0, "Maintenant je t'aime de plus en plus"),
]
...
NOTE_COLORS = ["#5A2E17", "#8B4513", "#D2691E", "#FF8C00"] 
