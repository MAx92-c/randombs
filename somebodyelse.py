...
LYRICS = [
    (0.0,  "I don't want your body"),
    (2.5,  "But I hate to think about you with somebody else"),
    (6.5,  "Our love has gone cold"),
    (9.0,  "You're intertwining your soul with somebody else"),
    (13.0, "I'm looking through you while you're looking through your phone"),
    (17.5, "And leaving with somebody else"),
    (21.0, "No, I don't want your body"),
    (24.5, "But I hate to think about you with somebody else"),
    (28.5, "Our love has gone cold"),
    (31.0, "You're intertwining your soul with somebody else"),
]
...
NOTE_COLORS = ["#2E1065", "#581C87", "#7E22CE", "#A855F7"] 
...
class LyricCard:
    def __init__(self, parent, text, x, y):
        ...
        self.label = tk.Label(
            ...
            wraplength=BOX_W - 30, justify="center"
        )
...
class LyricFloatApp:
    ...
    def random_safe_x(self):
        ...
        right_x = min(self.screen_w - BOX_W - 20, center_x + 40)
